...
//                ReProduct dialog = new ReProduct(holder.getAdapterPosition() ,khoFragment, context, bundle);
//                dialog.show();
...
//
//        public ReProduct(int position, SanPhamFragment khoFragment, Context context, Bundle bundle) {
//            super(context);
//            this.khoFragment = khoFragment;
...
//
//
//        private void uploadInfo(int position, String id){
...
//            Toast.makeText(context, tenne, Toast.LENGTH_SHORT).show();
