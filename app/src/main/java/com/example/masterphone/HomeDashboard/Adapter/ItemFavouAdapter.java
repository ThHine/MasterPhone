package com.example.masterphone.HomeDashboard.Adapter;
...
public class ItemFavouAdapter extends RecyclerView.Adapter<ItemFavouAdapter.ItemViewHolder>{
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.homedashboard_home_layoutitemfavou,parent,false);
