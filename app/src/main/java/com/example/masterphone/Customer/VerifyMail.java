                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(VerifyMail.this, "Vui lòng xác nhận gmail " + mUser.getEmail(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            if (verification == true) {
                                Intent intent = new Intent(VerifyMail.this, Success.class);
                                startActivity(intent);
                            } else {
                                Toast.makeText(VerifyMail.this, "Vui lòng xác nhận gmail", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
